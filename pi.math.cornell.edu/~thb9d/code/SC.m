function [p,t,v,l] = SC(level,numrefinements)
%sets up and solves eigenvalue problem on outer approximation of SC
...
%seven squares for each square already in the matrix
for i=1:m
    for j=1:8^(i-1)
        x1 = A(3,j)+1/(3^i);
        y1 = A(7,j);
