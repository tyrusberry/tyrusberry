function [p,t,v,l] = carpet1516(level,numrefinements)
%sets up and solves eigenvalue problem on outer approximation of 15/16
%carpet
...
%fifteen squares for each square already in the matrix
for i=1:m
    for j=1:15^(i-1)
        x1 = A(3,j)+1/(4^i);
        y1 = A(7,j);
